...
├── risk.py                # Position sizing, SL/TP/SAR exit evaluation, entry signals
├── telegram_reporter.py   # Hourly Markdown reports, FIFO PnL (long + short)
├── main.py                # 15-second loop, orchestration, gc.collect()
...
- Python 3.10+
- 1 CPU core, 2 GB RAM minimum (tested target)
- WSL/Debian 13 or any Linux
